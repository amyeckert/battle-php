...
//instantiate new service classes so you can use them:
$shipLoader = new ShipLoader();
$ships = $shipLoader->getShips();

// create variables to get the name and amount of ships chosen to battle in form on index.php 
...
// creat a new balttle manager object
$battleManager = new BattleManager();
// define a variable to store the results using these variables from the batle manager:
    ...
    <body>
        <div class="container">
            ...
            <div class="result-box center-block">
                ...
                <p class="text-center">
                    <?php if (!$battleResult->isThereAWinner()): ?> <!-- if there is not a winner-->
                        Both ships destroyed each other in an epic battle to the end.
                    <?php else: ?>
                        The <?php echo $battleResult->getWinningShip()->getName(); ?> <!-- if there is a winner-->
